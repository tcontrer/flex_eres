    ...
    for name in mcs:
        ...
        if mc['run']:
            ...
            with open('macros/'+pyfile_name, 'w') as f:
                ...
                f.write("data_dir = '/n/holystore01/LABS/guenette_lab/Lab/data/NEXT/FLEX/mc/eres_22072022/full_sims/'+mc_name+'/'+event_type+'/buffy/reduced_hdf5/'\n") 
            ...
            with open('macros/'+batchfile_name, 'w') as f:
                ...
                f.write("#SBATCH -p serial_requeue                           # Partition to submit to\n")
